    ...
    $(document).ready(function () {
        ...
        if ($('.team-carousel').length) {
            $('.team-carousel').owlCarousel({
                ...
                smartSpeed: 1000,
                autoplay: 5000,
                navText: [ '<span class="flaticon-left-arrow-1 aria-label="Previous Slide" role="button" aria-label="Previous Slide"></span>', '<span class="flaticon-right-arrow-1 aria-label="next Slide" role="button" aria-label="Next Slide"></span>' ],
                responsive:{
                    0:{
                        items:1
                    },
         ...
         if ($('.team-carousel2').length) {
            $('.team-carousel2').owlCarousel({
                ...
                smartSpeed: 1000,
                autoplay: 5000,
                navText: [ '<span class="flaticon-left-arrow-1  role="button" aria-label="Previous Slide""></span>', '<span class="flaticon-right-arrow-1"  role="button" aria-label="Next Slide"></span>' ],
                responsive:{
                    0:{
                        items:1
                    },
